    ...
    <main className="p-0">
      <header className="py-12 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="relative shadow-lg rounded-2xl overflow-hidden bg-white border border-slate-200 hover:shadow-xl transition-shadow duration-300">
            <input 
              type="text" 
              placeholder="Ex: Cartão de visita, Banner, Adesivo..." 
              className="w-full h-16 pl-14 pr-36 outline-none text-slate-700 placeholder:text-slate-400 focus:bg-slate-50 transition-colors"
            />
            <div className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400">
              <Search size={22} />
            </div>
            <button 
              className="absolute right-2 top-2 bottom-2 px-8 rounded-xl font-semibold text-white transition-all hover:brightness-110 hover:shadow-lg active:scale-95"
